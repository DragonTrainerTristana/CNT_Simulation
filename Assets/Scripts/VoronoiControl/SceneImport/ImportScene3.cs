...
public class ImportScene3 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        silicaPosFile = Application.dataPath + "/DataFiles/Option3/points3.csv";
        voronoiVertexPositionFile = Application.dataPath + "/DataFiles/Option3/voronoi_vertices3.csv";
        voronoiDictFile = Application.dataPath + "/DataFiles/Option3/voronoi_dict3.json";
