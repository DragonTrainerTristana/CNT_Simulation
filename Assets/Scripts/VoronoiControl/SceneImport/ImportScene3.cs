...
public class ImportScene3 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        silicaPosFile = Application.dataPath + "/StreamingAssets/Option3/points3.csv";
        voronoiVertexPositionFile = Application.dataPath + "/StreamingAssets/Option3/voronoi_vertices3.csv";
        voronoiDictFile = Application.dataPath + "/StreamingAssets/Option3/voronoi_dict3.json";
